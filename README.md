...
```javascript
import flag from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-flag@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-flag/tags). For example,

```javascript
import flag from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-flag@v0.2.3-deno/mod.js';
```
...
[@stdlib/ndarray/flags]: https://github.com/stdlib-js/ndarray-flags/tree/deno
